 ...
 */
void g_hash_table_string_free(gpointer data) { g_string_free(data, TRUE); }

/**
 * common GString free func as a hook
 */
void g_string_true_free(gpointer data) { g_string_free(data, TRUE); }
 ...
 */
gboolean g_hash_table_true(gpointer UNUSED_PARAM(key),
                           gpointer UNUSED_PARAM(value),
