...
network_injection_queue *network_injection_queue_new() { return g_queue_new(); }
...
void network_injection_queue_append(network_injection_queue *q,
                                    injection *inj) {
  g_queue_push_tail(q, inj);
}

void network_injection_queue_prepend(network_injection_queue *q,
                                     injection *inj) {
