...
CHASSIS_API int
chassis_frontend_init_plugins(GPtrArray *plugins, chassis_options_t *option_ctx,
                              struct chassis_config_t *config_manager,
                              int *argc_p, char ***argv_p, GKeyFile *keyfile,
                              const char *keyfile_section_name, GError **gerr);
...
CHASSIS_API int chassis_options_set_cmdline_only_options(
    chassis_options_t *opts, int *print_version, char **config_file);
